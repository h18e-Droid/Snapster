...
export const HeaderOnThePost = ({selectedFiles,handleBack,handleCloseModal,NextStageHandler}: Props) => {
  return (
    <div>
      {selectedFiles.length > 0 ? (
        <div className={"modal-header"}>
          ...
          <h2>Cropping</h2>
          <button className={"nextBtn"} onClick={NextStageHandler}>Next</button>
        </div>
      ) : (
        <div className={"modal-header"}>
          <h2>Add Photo</h2>
